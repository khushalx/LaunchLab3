...
function renderProductView() {
  ...
  Object.entries(productUpgrades).forEach(([key, upgrade]) => {
    ...
    card.innerHTML = `
      ...
      <div class="upgrade-icon" aria-hidden="true">${productUpgradeIcons[key] || "▣"}</div>
  ...
  items.forEach((item) => {
    ...
    if (typeof item === "object") {
      ...
      li.innerHTML = `
        ...
        <i aria-hidden="true">${productUpgradeIcons[item.key] || "▣"}</i>
        <div>
      ...
      if (isShippedList) {
        ...
        li.innerHTML = `
          ...
          <div>
            <strong>${productUpgradeIcons[shipped.key] || "▣"} ${shipped.label}</strong>
        ...
        li.innerHTML = `
          <i aria-hidden="true">${productUpgradeIcons[key] || "▣"}</i>
          <div>
            <strong>${item}</strong>
